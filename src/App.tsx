...
import ApprovalArea from './pages/approvals/area'
      ...
      <DataProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/nova-solicitacao" element={<ProtectedRoute roles={['admin', 'requester', 'area_manager']}><NewRequest /></ProtectedRoute>} />
            <Route path="/aprovacao-area" element={<ProtectedRoute roles={['admin', 'area_manager']}><ApprovalArea /></ProtectedRoute>} />

...
export default function Layout({ children }: { children: ReactNode }) {
  ...
  // Componente interno — renderizado tanto na sidebar desktop quanto no overlay mobile.
  // Definir como função interna evita duplicar o JSX.
            ...
            {visibleItems.map((item) => {
              ...
              return (
                <li key={item.to}>
                  <Link
                    to={item.to}
                    onClick={() => setSidebarOpen(false)} // fecha o menu ao clicar em mobile

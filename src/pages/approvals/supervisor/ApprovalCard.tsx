...
export default function ApprovalCard({ request, onApprove }: Props) {
  ...
  // Valida e envia a decisão
  function handleSubmit(approved: boolean) {
    // Para aprovar, obrigatoriamente precisa selecionar um fornecedor
    if (approved && !selectedId) { setError('Selecione um fornecedor para aprovar.'); return }
    setError('')

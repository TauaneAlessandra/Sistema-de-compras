...
const STATUS_MAP: Record<RequestStatus, StatusInfo> = {
  ...
  fulfilled_by_stock: { label: 'Em Estoque', color: 'bg-teal-100 text-teal-700', icon: <CheckCircle2 size={12} /> },
}
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        {(user!.role === 'requester' || user!.role === 'area_manager' || user!.role === 'admin') && (
          <Link
            to="/nova-solicitacao"
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 flex flex-col sm:flex-row gap-3">
        ...
        >
          ...
          <option value="fulfilled_by_stock">Em Estoque</option>
        </select>
      </div>
